...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb  7 20:53:19 2022
...
ext = '/Users/localadmin/Dropbox/David/PhDTUDelft/kwinstheul/'
# The store we are going extract data from:
station_file = ext + 'temporal_codes/stations.txt'
...
stations = model.load_stations(station_file)
...
# read quakeml events
qml = quakeml.QuakeML.load_xml(filename=
                               '/Volumes/Expansion/kwinstheul/06_events/events.xml')
# get pyrocko events
